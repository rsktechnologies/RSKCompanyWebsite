...
const process = [
  { step: "01", icon: MessageSquare, title: "Discovery", description: "We align on goals, constraints, and success metrics before anything else." },
  { step: "02", icon: Database, title: "Architecture", description: "We design scalable systems that won't break under growth." },
  { step: "03", icon: Code2, title: "Development", description: "Focused sprints with weekly demos and real-time feedback loops." },
  { step: "04", icon: Globe, title: "Launch", description: "We deploy, monitor, and ensure everything runs perfectly at go-live." },
  { step: "05", icon: TrendingUp, title: "Evolve", description: "We stay onboard to iterate, optimize, and scale as you grow." },
];
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-20 sm:px-6 sm:py-28 lg:px-8">
          ...
          <Reveal delay={0.12}>
            <p className="mt-6 max-w-2xl text-pretty text-lg leading-relaxed text-neutral-700 sm:text-xl">
              From web development to mobile apps, cloud infrastructure, and security —
              we build digital solutions that help businesses scale, innovate, and compete.
            </p>
          </Reveal>
          <Reveal delay={0.18}>
            <div className="mt-8 flex flex-wrap gap-3">
              {["#Design", "#Software", "#Cloud", "#CyberSecurity", "#Mobile", "#MVP"].map((tag) => (
                <span key={tag} className="rounded-full border border-[rgb(51,51,153)]/20 bg-white/60 px-3 py-1 text-xs font-semibold text-[rgb(51,51,153)] backdrop-blur">
                  {tag}
                </span>
              ))}
            </div>
        ...
        <div className="mx-auto max-w-6xl px-4 py-20 sm:px-6 sm:py-28 lg:px-8">
          <Reveal>
            ...
            <p className="mt-3 max-w-xl text-base text-neutral-600">
              Every engagement follows the same proven playbook — so you always know what happens next.
            </p>
          </Reveal>
            ...
            {process.map((item, i) => (
              <Reveal key={item.step} delay={0.06 * i}>
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="mb-0.5 text-xs font-bold tabular-nums text-[rgb(51,51,153)]/40">{item.step}</p>
            ...
            <div className="relative rounded-2xl border border-[rgb(51,51,153)]/15 bg-white/60 px-8 py-14 text-center shadow-xl backdrop-blur-md sm:px-16">
              ...
              <div className="relative">
                ...
                <p className="mx-auto mt-3 max-w-md text-pretty text-base text-neutral-600">
                  Let's discuss your project and see how we can help you build, ship, and scale.
                </p>
                <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
                  <Link href="/contact" className="inline-flex h-12 items-center justify-center gap-2 rounded-full bg-[rgb(51,51,153)] px-7 text-sm font-semibold text-white shadow-lg transition-all duration-200 hover:-translate-y-0.5 hover:bg-[rgb(41,41,128)] hover:shadow-xl">
                    Start a conversation <ArrowRight size={15} />
                  </Link>
                  <Link href="/about" className="inline-flex h-12 items-center justify-center gap-2 rounded-full border border-[rgb(51,51,153)]/35 px-7 text-sm font-semibold text-[rgb(51,51,153)] transition-colors hover:bg-[rgb(51,51,153)]/10">
