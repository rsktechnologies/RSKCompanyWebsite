...
export function LogoLink({
  ...
  return (
    ...
    >
      <span className="relative h-12 w-12 shrink-0 overflow-hidden rounded-lg bg-[rgb(51,51,153)]/10 shadow-[0_12px_40px_-18px_rgba(51,51,153,0.85)] ring-1 ring-[rgb(51,51,153)]/25 transition-transform duration-300 group-hover:-translate-y-0.5 group-hover:shadow-[0_20px_50px_-20px_rgba(51,51,153,0.95)] sm:h-14 sm:w-14">
        <Image
          src="/brand/logo.jpeg"
